// resources/js/layouts/Partials/KepalaBagianSidebar.tsx

import { Link, usePage } from '@inertiajs/react';

// Tipe data umum, bisa kita gunakan kembali
...
export default function KepalaBagianSidebar() {
...
<aside className="sidebar bg-gradient-to-b from-violet-500 via-violet-800 to-violet-900 w-64 p-6 shadow-2xl flex flex-col justify-between rounded-xl border border-violet-600">
    <div>
        ...
        <nav>
            <SidebarLink href={route('kabag.dashboard')} active={route().current('kabag.dashboard')}>
            ...
            <SidebarLink href={route('kabag.notifications')} active={route().current('kabag.notifications')}>
                <svg className="w-5 h-5 mr-3 text-violet-300 group-hover:text-white transition" fill="currentColor" viewBox="0 0 20 20">
